    ...
    <div class="main-wrapper">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">
                Hi, <?= $session->get('user_name') ?? 'Guest' ?>
            </div>
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <?php else: ?>
                <div class="dropdown-title">Silahkan Login</div>
                <a href="<?=site_url('login')?>" class="dropdown-item has-icon text-primary">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?=base_url()?>">PJF</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href=<?=base_url()?>"index.html">St</a>
          </div>
      ...
      <footer class="main-footer">
        <div class="footer-right">
          ...
          Copyright &copy; 2025 <div class="bullet"></div> Devloped By <a href="">M.Revan</a>
        </div>
        <!-- <div class="footer-right">
          2.3.0
