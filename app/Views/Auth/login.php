      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <form method="POST" action="<?=site_url('login_process')?>" class="needs-validation" novalidate="">
              <?=csrf_field()?>
              ...
              <div class="mt-5 text-center">
                Don't have an account? <a href="<?=site_url('register')?>">Create new one</a>
              </div>
            </form>
          ...
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                ...
                <h5 class="font-weight-normal text-muted-transparent">Login</h5>
              </div>
